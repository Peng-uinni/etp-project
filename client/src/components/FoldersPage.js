    ...
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Organize your transcripts into folders for easy access</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {folders.map((folder) => (
            <div key={folder.id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition p-6 relative group">
              ...
              <button className="mt-4 w-full px-4 py-2 bg-gray-100 text-gray-900 rounded-lg hover:bg-gray-200 transition">
                Open Folder
              </button>
            </div>
          ))}
